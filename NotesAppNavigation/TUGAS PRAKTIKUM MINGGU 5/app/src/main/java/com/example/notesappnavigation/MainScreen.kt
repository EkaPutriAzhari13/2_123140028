...
import com.example.notesappnavigation.ui.theme.PinkPrimary
...
fun MainScreen() {
    ...
    val notes = remember {
        mutableStateListOf(
            Note(42, "Tugas Pemrograman Mobile", "Deadline besok pagi jam 8", "Kerjakan bagian navigasi dan pastikan datanya dinamis sesuai permintaan user.", "08:00 AM"),
            Note(43, "Belanja Bulanan", "Beli kebutuhan dapur", "List belanja: Beras, minyak, telur, dan kopi buat begadang ngoding.", "07:00 PM"),
            Note(44, "Meeting Project", "Diskusi via Zoom", "Persiapkan materi presentasi mengenai arsitektur aplikasi terbaru.", "02:00 PM")
        )
    }
